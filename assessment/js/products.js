const getProducts = async () => {
  ...
  =============
   */
  const pic1 = document.getElementById("product1");
  const pic2 = document.getElementById("product2");
  const pic3 = document.getElementById("product3");
  const pic4 = document.getElementById("product4");
  const pic5 = document.getElementById("product5");
